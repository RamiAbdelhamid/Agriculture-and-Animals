...
// import { Calendar, AlertCircle, CheckCircle, ClipboardList, User, Clock } from "lucide-react";
...
//       const doctorReservations = response.data.filter((booking) => booking.notified);
...
//       setError("Failed to load doctors and reservations. Please try again later.");
//       setLoading(false);
//     }
//   };
...
//                   <p>No reservations found for Dr. {selectedDoctor} with the selected filter.</p>
//                 </div>
//               ) : (
...
//                             </span>
//                             {getStatusBadge(reservation.status, reservation.emergency, reservation.completed)}
//                           </div>
...
//                             <span className="text-sm text-gray-500">Booking ID: {reservation._id}</span>
//                           </div>
