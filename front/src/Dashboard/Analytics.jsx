...
const Analytics = () => {
  ...
  const generateMonthlyData = (bookings, products) => {
    ...
    for (let i = 11; i >= 0; i--) {
      ...
      // For each month, count the number of completed bookings
      ...
      // Calculate revenue (10 JOD per completed booking)
      const revenueInMonth = completedInMonth * 10;

      // For products, we'll simulate growth since we don't have historical data
      const productsInMonth = products.length; // Use the exact number of products without simulation
