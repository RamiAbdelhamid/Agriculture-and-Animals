...
//   // Fetch existing vets and departments
//   useEffect(() => {
//     fetchVetsAndDepartments();
//   }, []);

//   const fetchVetsAndDepartments = async () => {
//     try {
//       // In a real app, these would be API calls
//       // For now, we'll use the sample data from the original component
//       setDepartments([
...
//     if (departments.some((dept) => dept.id === newDepartment.id)) {
...
//   const handleDeleteVet = (vetName) => {
//     if (window.confirm(`Are you sure you want to delete Dr. ${vetName}?`)) {
...
//       // Check if any vets are assigned to this department
//       const vetsInDept = vets.filter((vet) => vet.department === deptId);
//       if (vetsInDept.length > 0) {
//         alert(
//           `Cannot delete department. ${vetsInDept.length} veterinarian(s) are assigned to it.`
//         );
//         return;
//       }
